...
public class MultipleOperationsMain extends AppCompatActivity {
...
*/
    ...
    public void practiseRanges(){
        Intent intent = new Intent(getApplicationContext(), MultipleOperationsNumberRangeMain.class);
        startActivity(intent);
    }
    ...
    public void goToMultipleType (View view){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multipleoperations_home);
