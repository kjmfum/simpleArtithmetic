...
*/
    ...
    public void newHighScoreList(int level) {
        switch (level){
            case 1:
                level1HighScores("DIV",1);
                return;
            case 2:
                level1HighScores("DIV2",2);
                return;
            case 3:
                level1HighScores("DIV3",3);
                return;
            case 4:
                level1HighScores("DIV4",4);
                return;
            case 5:
                level1HighScores("DIV5",4);
                return;
        }
    }
    ...
    public void HighScoreList(int level){
        switch (level){
            case 1:
                level1HighScoreList("DIV");
                return;
            case 2:
                level1HighScoreList("DIV2");
                return;
            case 3:
                level1HighScoreList("DIV3");
                return;
            case 4:
                level1HighScoreList("DIV4");
                return;
            case 5:
                level1HighScoreList("DIV5");
                return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences preferences = getSharedPreferences("DIV", 0);
