...
public class MultiplicationHighScores extends AppCompatActivity {
    AdView mAdView;
...
*/
    ...
    public void goToLevel(int level, int minimum, int maximum){
        Intent intent = new Intent(this, MultiplicationFinishPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_high_scores);
