...
public class MultiplicationCountdownMain extends AppCompatActivity {
...
*/
    ...
    public void goToLevel(int level, int minimum, int maximum){
        Intent intent = new Intent(this, MultiplicationActivityCountdown.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multiplication_countdown_main);
