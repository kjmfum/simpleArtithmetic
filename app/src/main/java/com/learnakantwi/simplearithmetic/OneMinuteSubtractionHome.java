...
public class OneMinuteSubtractionHome extends AppCompatActivity {
...
*/
    ...
    public void goToDivision0to9(int minimum, int maximum, int divisor){
        ...
        Intent intent = new Intent(this, OneMinuteSubtractionActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_minute_subtraction_home);
