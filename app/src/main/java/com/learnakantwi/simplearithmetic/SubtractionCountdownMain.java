...
public class SubtractionCountdownMain extends AppCompatActivity {
    AdView mAdView;
...
*/
    ...
    public void goToLevel(int level, int minimum, int maximum){
        Intent intent = new Intent(this, SubtractionActivityCountdown.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtraction_countdown_main);
