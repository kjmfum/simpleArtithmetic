...
public class DivisionHighScores extends AppCompatActivity {
    AdView mAdView;
...
*/
    ...
    public void goToLevel(int level, int minimum, int maximum){
        Intent intent = new Intent(this, DivisionFinishPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_division_high_scores);
