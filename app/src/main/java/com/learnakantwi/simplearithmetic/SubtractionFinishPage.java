...
public class SubtractionFinishPage extends AppCompatActivity {
...
*/
    ...
    public void newHighScoreList(int level) {
        switch (level){
            case 1:
                level1HighScores("SUB",1);
                return;
            case 2:
                level1HighScores("SUB2",2);
                return;
            case 3:
                level1HighScores("SUB3",3);
                return;
            case 4:
                level1HighScores("SUB4",4);
                return;
            case 5:
                level1HighScores("SUB5",5);
                return;
        }
    }
    ...
    public void HighScoreList(int level){
        switch (level){
            case 1:
                level1HighScoreList("SUB");
                return;
            case 2:
                level1HighScoreList("SUB2");
                return;
            case 3:
                level1HighScoreList("SUB3");
                return;
            case 4:
                level1HighScoreList("SUB4");
                return;
            case 5:
                level1HighScoreList("SUB5");
                return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvLastScore.setVisibility(View.GONE);
        ...
        SharedPreferences preferences = getSharedPreferences("SUB", 0);
