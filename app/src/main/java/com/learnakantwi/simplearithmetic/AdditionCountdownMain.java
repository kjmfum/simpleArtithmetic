...
public class AdditionCountdownMain extends AppCompatActivity {
...
*/
    ...
    public void goToLevel(int level, int minimum, int maximum){
                Intent intent = new Intent(this, AdditionActivityCountdown.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition_countdown_main);
