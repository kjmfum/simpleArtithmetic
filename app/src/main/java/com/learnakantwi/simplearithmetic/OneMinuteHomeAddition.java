...
public class OneMinuteHomeAddition extends AppCompatActivity {
...
*/
    ...
    public void goToDivision0to9(int minimum, int maximum, int divisor){
        ...
        Intent intent = new Intent(this, OneMinuteAdditionActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_minute_home_addition);
